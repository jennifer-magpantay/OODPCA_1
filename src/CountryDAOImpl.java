...
public class CountryDAOImpl implements CountryDAO{
	...
	public Country getCountryByName() {
		...
		//adding validation to check against validation method
		do {				
			try {
		...
		//if the validation is ok, then start the query			
	...
	public Country getCountryByCode() {
		...
		//if the validation is ok, then keep going
	...
	public Country addNewCountry() {
		...
		CountryAbs myCountry = new Country.CountryAbsBuilder().build();
